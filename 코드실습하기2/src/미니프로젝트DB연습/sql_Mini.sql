...
create table Minicharac(char_nick varchar2(10), mem_id varchar2(10) not null,
cha_type varchar2(10) not null, wokr_ability number (3) not null, lv number (3),
exp number (3), energy number (3), stress number (3),
